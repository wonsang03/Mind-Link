...
/** AI 종합 보고서 프롬프트·JSON 응답 파싱 */
final class CareLetterPromptBuilder {

    private CareLetterPromptBuilder() {}

    static String build(String snapshotJson, CareReport.RiskLevel riskLevel) {
    ...
    static Optional<CareLetterAiResult.LetterDraft> parseResponse(String rawText, ObjectMapper mapper) {
        try {
            ...
            return Optional.of(new CareLetterAiResult.LetterDraft(letter, themes));
        } catch (Exception e) {
            return Optional.empty();
        }
    }
