...
BEGIN
  ...
  SELECT COUNT(*) INTO c FROM user_tables WHERE table_name = 'SCORE_RANGES';
  IF c = 0 THEN
    EXECUTE IMMEDIATE q'[
      CREATE TABLE score_ranges (
        ...
        level              VARCHAR2(30 CHAR) NOT NULL,
...
DELETE FROM score_ranges;
DELETE FROM assessment_choices;
